...
//        Book dogs = dogsService.getDogById(id);
//        return ResponseEntity.ok().body(dogs);
//    }
//
//    @PostMapping("/dogs")
//    public Book createDog(@Valid @RequestBody Book dog) {
//        return dogsService.addDog(dog);
//    }
//
//    @PutMapping("/dogs/{id}")
//    public ResponseEntity <Book> updateDog(@PathVariable(value = "id") Long id,
//                                           @Valid @RequestBody Book dogDetails) throws ResourceNotFoundException {
//
//        final Book updatedDogs = dogsService.updateDogDetails(dogDetails);
